...
import HRS7 from "./assets/HRS7.jpg";
import HRS8 from "./assets/HRS8.jpg";
import HRS9 from "./assets/HRS9.jpg";
import HRS10 from "./assets/HRS10.jpg";
import HRS11 from "./assets/HRS11.jpg";
import HRS12 from "./assets/HRS12.jpg";
...
const SalonDetailModal = ({ salon, onClose }) => {
  ...
  const promoCodes = [
    { code: 'NEWOFF', discount: '30% OFF', expiry: '20 Aug 2023', color: 'promo-pink' },
    { code: 'FLAT50', discount: '50% OFF', expiry: '25 Aug 2023', color: 'promo-blue' },
    { code: 'SAVE40', discount: '$40', expiry: '27 Aug 2023', color: 'promo-orange' },
    { code: 'BIG80', discount: '80% OFF', expiry: '30 Aug 2023', color: 'promo-green' },
  ];
  ...
  <div className="search-container">
    ...
    {searchQuery && (
      <div className="search-results absolute bg-white w-full mt-2 shadow-lg rounded-lg z-50">
        ...
        <Link to="/signup/salon" className="partner-link">
          <img 
            src={PartnerIcon} 
            alt="Partner with Us" 
                ...
                >
                  <div className="salon-image-container">
                    ...
                    <span className={`salon-type ${
                      salon.type === 'Unisex' ? 'type-unisex' : 
                      salon.type === 'Male' ? 'type-male' : 'type-female'
                    }`}>
                      {salon.type}
                    </span>
                    <div className="rating-badge">
                      <FaStar className="star-icon" />
                      <span className="rating-text">{salon.rating}</span>
                    </div>
                  </div>
            ...
            <div className="map-grid">
              <div className="social-section">
                <div className="social-content">
                  <h3 className="social-subtitle">SOCIAL NETWORK</h3>
                  <h2 className="social-title">Follow us on our network</h2>
                ...
                <div className="newsletter-section">
                  <h3 className="newsletter-subtitle">NEWSLETTER</h3>
        ...
        <footer className="footer">
          <div className="footer-container">
            ...
            <div className="copyright">
              © 2024 GlamTech. All rights reserved.
            </div>
          </div>
        </footer>
{selectedSalon && (
